...
class TestBasic(BaseJITTest):
    ...
    def test_range_asOrderedCollection(self, spy, tmpdir):
        ...
        self.assert_matches(traces[0].loop, """
             ...
             p208 = getfield_gc_pure(p205, descr=<FieldP spyvm.shadow.ListStrategy.inst_storage 16>),
             ...
             p214 = getfield_gc_pure(p213, descr=<FieldP spyvm.shadow.SmallIntegerOrNilStrategy.inst_storage 16>),
             i215 = arraylen_gc(p214, descr=<ArrayS 4>),
             i216 = getfield_gc_pure(p213, descr=<FieldU spyvm.shadow.AbstractObjectStorage.inst_space 12>),

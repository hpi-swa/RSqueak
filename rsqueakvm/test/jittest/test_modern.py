...
i := n' classified: 'none' withStamp: nil notifying: nil logSource: false.
    ...
    def test_interval_do(self, spy, tmpdir):
        ...
        i235 = getfield_gc_i(p212, descr=<FieldS rsqueakvm.model.numeric.W_LargeIntegerBig.inst__exposed_size 40>)
        p236 = getfield_gc_r(p212, descr=<FieldP rsqueakvm.model.numeric.W_LargeIntegerBig.inst_value 48 pure>)

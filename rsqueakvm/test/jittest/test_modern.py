...
class TestModern(ModernJITTest):
    ...
    def test_benchFib(self, spy, squeak, tmpdir):
        ...
        i31 = getfield_gc_i(p8, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8 pure>),
        i33 = int_lt(i31, 2),
        ...
        p38 = getfield_gc_r(ConstPtr(ptr37), descr=<FieldP rsqueakvm.model.W_PointersObject.inst_strategy 20>),
        guard_value(p38, ConstPtr(ptr39), descr=<Guard0xa655730>),
        p41 = getfield_gc_r(ConstPtr(ptr40), descr=<FieldP rsqueakvm.model.W_PointersObject.inst_strategy 20>),
        ...
        setfield_gc(p78, i35, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8 pure>),
        ...
        i108 = int_sub(i31, 2),
        p110 = getfield_gc_r(ConstPtr(ptr109), descr=<FieldP rsqueakvm.model.W_PointersObject.inst_strategy 20>),
        ...
        p114 = getfield_gc_r(ConstPtr(ptr113), descr=<FieldP rsqueakvm.model.W_PointersObject.inst_strategy 20>),
        ...
        setfield_gc(p151, i108, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8 pure>),

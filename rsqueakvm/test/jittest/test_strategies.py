...
class TestBasic(BaseJITTest):
    ...
    def test_range_asOrderedCollection(self, spy, tmpdir):
        ...
        self.assert_matches(traces[0].loop, """
             ...
             setfield_gc(p202, i190, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8>),
             ...
             p203 = getfield_gc(p200, descr=<FieldP rsqueakvm.model.W_AbstractObjectWithClassReference.inst_w_class 12>),
             p204 = getfield_gc(p203, descr=<FieldP rsqueakvm.model.W_PointersObject.inst_shadow 16>),
             guard_value(p204, ConstPtr(ptr121), descr=<Guard0x2eb32d0>),
             guard_not_invalidated(descr=<Guard0x2eb3250>),
             p205 = getfield_gc(p200, descr=<FieldP rsqueakvm.model.W_PointersObject.inst_shadow 16>),
             ...
             p211 = getfield_gc(p210, descr=<FieldP rsqueakvm.model.W_AbstractObjectWithClassReference.inst_w_class 12>),
             p212 = getfield_gc(p211, descr=<FieldP rsqueakvm.model.W_PointersObject.inst_shadow 16>),
             guard_value(p212, ConstPtr(ptr154), descr=<Guard0x2eb30d0>),
             p213 = getfield_gc(p210, descr=<FieldP rsqueakvm.model.W_PointersObject.inst_shadow 16>),
             ...
             i217 = getfield_gc_pure(p209, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8>),
             ...
             setfield_gc(p228, i219, descr=<FieldS rsqueakvm.model.W_SmallInteger.inst_value 8>),

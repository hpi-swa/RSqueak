...
class CompoundShape(Shape):
    ...
    def extract_child(self, w_c, index):
        ...
        if subshape is in_storage_shape:
            return w_c._get_raw_storage_at(storage_index)
        else:
            newlen = subshape.storage_width()
            endindex = storage_index + newlen
            assert endindex <= self.storage_width()
            new_storage = (w_c._get_raw_storage())[storage_index:endindex]
    ...
    def record_shape(self, child, i):
        ...
        width = child._get_raw_storage_width()
...
class InStorageShape(Shape):
    ...
    def extract_child(self, w_c, index):
        return w_c._get_raw_storage_at(index)
...
#         return W_Integer(w_c._get_raw_storage_at(index))
#     #
#     # Testing and Debug
#     #
